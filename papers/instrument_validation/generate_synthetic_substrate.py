...
_RELATIONS_POOL = [
    # v036 original 12 — kept first for stable IDs across regenerations.
    "is_a",
    "has_property",
    "part_of",
    "produces",
    ...
    "opposes",
    "enables",
    # v039 extension — top verbs mined from every brain.db.* in the repo,
    # filtered to drop noun-shaped noise (chromatids, fibers, ring) and
    # substrate plumbing (refutation_of, refutation_status, describes).
    # Append-only — never reorder; manifest IDs stay diff-friendly.
    "has",
    "causes",
    "activates",
    "becomes",
