...
def pair_to_example(pair, nlp) -> GrammarTrainExample | None:
    ...
    parsed: ParsedSentence = parse_sentence(pair.prose, nlp)
    if not parsed.words:
        return None
